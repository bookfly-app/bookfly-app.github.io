import{x as Vf,b as Of,h as Oi,C as Lf,aK as Mf,O as Li,L as xf,an as vu,_ as Au,Z as Ru,av as bu,aB as Pu,aL as Su,G as Cu,c as Mi,J as xi,aH as Uf,i as Ff,l as Bf,ab as tl,g as Bs,aa as nl,t as rl,s as cs,j as Is,r as ws,d as $f}from"./DBPlaF8E.js";import{a as So,r as sl}from"./BW7aK-Zr.js";import{a as il,n as ol}from"./gFbpwaTI.js";import{s as al,a as ls}from"./o2l4qZHV.js";const Ui=0,es=1,Fi=2;function Dv(n,e,t,r,s){Oi&&Lf();var i=n,a=Vf(),u=Bf,l=vu,d,p,y,v=(a?Au:Ru)(void 0),b=(a?Au:Ru)(void 0),k=!1;function N(M,F){k=!0,F&&(bu(C),Pu(C),Su(u));try{M===Ui&&t&&(d?Cu(d):d=Mi(()=>t(i))),M===es&&r&&(p?Cu(p):p=Mi(()=>r(i,v))),M!==Ui&&d&&xi(d,()=>d=null),M!==es&&p&&xi(p,()=>p=null),M!==Fi&&y&&xi(y,()=>y=null)}finally{F&&(Su(null),Pu(null),bu(null),Uf())}}var C=Of(()=>{if(l!==(l=e())){if(Mf(l)){var M=l;k=!1,M.then(F=>{M===l&&(Li(v,F),N(es,!0))},F=>{if(M===l)throw Li(b,F),N(Fi,!0),b.v}),Oi?t&&(d=Mi(()=>t(i))):xf(()=>{k||N(Ui,!0)})}else Li(v,l),N(es,!1);return()=>l=vu}});Oi&&(i=Ff)}function Nv(n,e,t,r){var s=n.__styles??(n.__styles={});s[e]!==t&&(s[e]=t,t==null?n.style.removeProperty(e):n.style.setProperty(e,t,""))}var ku={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gd="storage";function ew(n,e,t){return n=ee(n),WI(n,e,t)}function tw(n){return n=ee(n),KI(n)}function Wd(n,e){return n=ee(n),YI(n,e)}function nw(n=Do(),e){n=ee(n);const r=qs(n,Gd).getImmediate({identifier:e}),s=dl("storage");return s&&rw(r,...s),r}function rw(n,e,t,r={}){ZI(n,e,t,r)}function sw(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new wa(t,r,s,e,Jt)}function iw(){Ht(new St(Gd,sw,"PUBLIC").setMultipleInstances(!0)),We(Jc,Xc,""),We(Jc,Xc,"esm2017")}iw();let Xn,Yc,Zc;function kn(){return Xn||(Xn=yl(GT.firebase),Yc=cy(Xn),Zc=nw(Xn)),{app:Xn,db:Yc,storage:Zc}}let{db:ow}=kn();async function Mv(n){let e=(await Te(Ee(se(ow,"posts"),fe("books","array-contains",n),qh("timestamp","desc")))).docs.map(t=>t.data());return await Promise.all(e.map(t=>nn(t)))}async function Er(n){var u,l,d,p;const e=localStorage.getItem(`book-${n}`);if(e)return JSON.parse(e);let[t,r]=await Promise.all([fetch(`https://openlibrary.org/isbn/${n}.json`),fetch(`https://www.googleapis.com/books/v1/volumes?q=isbn:${n}`)]),[s,i]=await Promise.all([t.json(),r.json()]);i=(u=i.items)==null?void 0:u[0].volumeInfo;const a={title:s.title,authors:Array.from(new Set((i==null?void 0:i.authors)??[])),isbn:n,cover:`https://covers.openlibrary.org/b/isbn/${n}-L.jpg`,backupCover:(l=i==null?void 0:i.imageLinks)==null?void 0:l.thumbnail,pageCount:s.number_of_pages,genres:((d=s.subjects)==null?void 0:d.map(y=>y.name))??[],description:(i==null?void 0:i.description)??((p=s.description)==null?void 0:p.value)??""};return localStorage.setItem(`book-${n}`,JSON.stringify(a)),console.log(`Updated book "${a.title}" in localStorage`),a}async function xv(n,e=10){/^\d{13}$/.test(n)&&Er(n).then(a=>[a]);const t=new URLSearchParams({q:n}),s=await(await fetch(`https://openlibrary.org/search.json?${t}&fields=isbn,editions`)).json();console.log(s);let i=s.docs.filter(a=>a.isbn).slice(0,e);return await Promise.all(i.map(a=>Er(a.isbn.find(u=>/^\d{13}$/.test(u)))))}let{db:Dn}=kn();function Uv(n){let e=[];return n.length<1&&e.push("Username can't be empty"),n.length>30&&e.push("Username can't be more than 30 characters"),/^[\w\-]*$/.test(n)||e.push("Username can only contain letters, numbers, underscores, and hyphens"),e}let Kd,Fv=new Promise(n=>{Kd=n});async function Bv(n){let t=(await Te(Ee(se(Dn,"posts"),fe("poster","==",n.id),fe("type","==","rating")))).docs.map(r=>r.data()).toSorted((r,s)=>s.rating-r.rating).map(r=>r.books[0]);return t.length>0?await Er(t[0]):null}async function $v(n){const e=[];return(await Te(Ee(se(Dn,"users"),fe("following","array-contains",n.id)))).forEach(t=>e.push(t.data())),e}async function aw(n){return(await Te(Ee(se(Dn,"users"),fe("id","==",n)))).docs[0].data()}async function uw(n){return n}async function qv(n){return(await Te(Ee(se(Dn,"users"),fe("username","==",n)))).docs[0].data()}async function jv(n){let e=(await Te(Ee(se(Dn,"posts"),fe("poster","==",n.id),qh("timestamp","desc")))).docs.map(r=>r.data());return await Promise.all(e.map(async r=>nn(r)))}async function zv(n){return(await Te(Ee(se(Dn,"users")))).docs.map(t=>t.data()).filter(t=>t.username.toLowerCase().includes(n.toLowerCase())||t.displayName.includes(n.toLowerCase()))}let{db:Nn}=kn();const Or=$T();PE(Or,Id);let bo=nl(null);function he(){return Bs(bo)}function Hv(n){let e=[];return/\d/.test(n)||e.push("Must contain at least 1 number"),/[a-z]/.test(n)||e.push("Must contain at least 1 lowercase letter"),/[A-Z]/.test(n)||e.push("Must contain at least 1 uppercase letter"),/[\$_=\+\*!@#%\^&\|\\\/\(\)\[\]\{\}<>\?:;'"`~\-]/.test(n)||e.push("Must contain at least 1 symbol"),n.length<8&&e.push("Must be at least 8 characters"),e}async function Gv(n){return(await Te(Ee(se(Nn,"users"),fe("username","==",n)))).docs.length>0}async function Wv(n){return(await Te(Ee(se(Nn,"users"),fe("email","==",n)))).docs.length>0}kE(Or,async n=>{n&&(tl(bo,So(await uw((await Te(Ee(se(Nn,"users"),fe("id","==",n.uid)))).docs[0].data()))),Kd(Bs(bo)))});async function Kv(){try{return await DE(Or),null}catch(n){return console.log(n),n}}async function cw(n){await Cr(et(Nn,"users",he().id),n)}async function Qv(n,e){await Wh(et(Nn,"users",n.id),e)}async function Jv(n,e,t){try{let r=await RE(Or,n,e),s={displayName:t,email:n,username:t,picture:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToiRnzzyrDtkmRzlAvPPbh77E-Mvsk3brlxQ&s",bio:"",pronouns:"",likes:[],id:r.user.uid,banner:"https://i0.wp.com/www.lifecaretechnology.com/wp-content/uploads/2018/12/default-banner.jpg?ssl=1",tags:[],links:[],currentBook:null,readingList:[],following:[],followers:[],views:[],shares:[],birthmoment:Date.now()};return await Wh(et(Nn,"users",s.id),s),null}catch(r){return console.log(r),r}}async function Xv(n,e){try{return await bE(Or,n,e),null}catch(t){return console.log(t),t}}let{db:Ue}=kn();async function Yv(n){let e={timestamp:Date.now(),poster:he().id,authors:[],books:[],views:[],likes:[],shares:[],pictures:[],id:"",...n};console.log(e);let t=await Py(se(Ue,"posts"),e);return Cr(t,{id:t.id}),nn({...e,id:t.id})}async function Zv(n){await by(et(Ue,"posts",n.id))}async function nn(n){let e={...n,poster:await aw(n.poster),books:await Promise.all(n.books.map(async t=>Er(t)))};return he()&&!he().views.includes(e.id)&&cw({views:[...he().views,e.id]}),e}async function eA(n){try{return nn((await Ry(et(Ue,"posts",n))).data())}catch{return null}}async function tA(n){let e=(await Te(Ee(se(Ue,"posts")))).docs.map(r=>r.data());return(await Promise.all(e.map(async r=>nn(r)))).filter(r=>r.body.toLowerCase().includes(n.toLowerCase()))}async function nA(n,e){if(n.following.length===0)return[];let t=fe("poster","in",n.following);t=Ty(t,fe("poster","==",n.id));let r=(await Te(Ee(se(Ue,"posts"),t))).docs.map(i=>i.data());return await Promise.all(r.map(async i=>nn(i)))}async function rA(n){return Promise.all((await Te(Ee(se(Ue,"posts"),fe("parent","==",n.id)))).docs.map(e=>nn(e.data())))}async function sA(n){return(await Te(Ee(se(Ue,"users"),fe("likes","array-contains",n.id)))).docs.map(e=>e.data())}async function iA(n){return(await Te(Ee(se(Ue,"users"),fe("shares","array-contains",n.id)))).docs.map(e=>e.data())}let lw=/(https?:\/\/)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/g;async function hw(n,e,t){const r=[];n.replaceAll(e,(i,...a)=>(r.push(t(i,...a)),i));const s=await Promise.all(r);return n.replaceAll(e,()=>s.shift())}async function oA(n){return n=n.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#x27;"),n=await hw(n,/@(\d{13})/g,async(e,t)=>{const r=await Er(t);return`<a style="text-decoration: none;" href="/book/${t}"><i>${r.title}</i></a>`}),n.replaceAll(/@(\w+)/g,(e,t)=>`<a style="text-decoration: none;" href="/profile/${t}">${e}</a>`).replaceAll(/\*\*([^\*]+)\*\*/g,(e,t)=>`<b>${t}</b>`).replaceAll(/\*([^\*]+)\*/g,(e,t)=>`<i>${t}</i>`).replaceAll(/`([^\`]+)`/g,(e,t)=>`<code>${t}</code>`).replaceAll(/~~([^~]+)~~/g,(e,t)=>`<s>${t}</s>`).replaceAll(lw,e=>`<a target="_blank" rel="noopener noreferrer" href="${e}">${e}</a>`).replaceAll(/\\\*/g,"*").replaceAll(/\\`/g,"`").replaceAll("`","&#x60;")}async function aA(n){let e=(await Te(Ee(se(Ue,"users"),fe("views","array-contains",n.id)))).docs,t=e.length;return(!he()||!e.map(r=>r.id).includes(he().id))&&(t+=1),t}async function uA(n){await Cr(et(se(Ue,"users"),he().id),{likes:[...new Set([...he().likes,n.id])]})}async function cA(n){await Cr(et(se(Ue,"users"),he().id),{shares:[...new Set([...he().shares,n.id])]})}async function lA(n){await Cr(et(se(Ue,"users"),he().id),{likes:he().likes.filter(e=>e!==n.id)})}function hA(n){var e;return((e=he())==null?void 0:e.likes.includes(n.id))??!1}function dA(n){if(!he()){let e=localStorage.getItem("shared-posts");return e?JSON.parse(e).includes(n.id):!1}return he().shares.includes(n.id)}async function fA(n){return he()?(await Te(Ee(se(Ue,"posts"),fe("parent","==",n.id),fe("poster","==",he().id)))).docs.length>0:!1}const dw=kn().db,Qd=kn().storage;async function pA(n,e="standard"){let t;return e==="profile picture"?t=`${he().id}_profile_picture`:t=et(se(dw,"__temp__")).id,await ew(Wd(Qd,t),n),t}async function mA(n){try{return await tw(Wd(Qd,n))}catch(e){return console.error(e),null}}var fw=ol('<svg><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M3.99999 10L12 3L20 10L20 20H15V16C15 15.2044 14.6839 14.4413 14.1213 13.8787C13.5587 13.3161 12.7956 13 12 13C11.2043 13 10.4413 13.3161 9.87868 13.8787C9.31607 14.4413 9 15.2043 9 16V20H4L3.99999 10Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>');function gA(n,e){let t=sl(e,["$$slots","$$events","$$legacy","stroke"]);var r=fw();let s;var i=cs(Is(r),2),a=Is(i);ws(i),ws(r),rl(()=>{s=al(r,s,{...t,viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg"},void 0,!0),ls(a,"stroke",e.stroke)}),il(n,r)}var pw=ol('<svg><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M12.12 12.78C12.05 12.77 11.96 12.77 11.88 12.78C10.12 12.72 8.71997 11.28 8.71997 9.50998C8.71997 7.69998 10.18 6.22998 12 6.22998C13.81 6.22998 15.28 7.69998 15.28 9.50998C15.27 11.28 13.88 12.72 12.12 12.78Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M18.74 19.3801C16.96 21.0101 14.6 22.0001 12 22.0001C9.40001 22.0001 7.04001 21.0101 5.26001 19.3801C5.36001 18.4401 5.96001 17.5201 7.03001 16.8001C9.77001 14.9801 14.25 14.9801 16.97 16.8001C18.04 17.5201 18.64 18.4401 18.74 19.3801Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>');function _A(n,e){let t=sl(e,["$$slots","$$events","$$legacy","stroke"]);var r=pw();let s;var i=cs(Is(r),2),a=Is(i),u=cs(a),l=cs(u);ws(i),ws(r),rl(()=>{s=al(r,s,{...t,viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg"},void 0,!0),ls(a,"stroke",e.stroke),ls(u,"stroke",e.stroke),ls(l,"stroke",e.stroke)}),il(n,r)}const mw="Catppuccin Mocha",gw="catppuccin-mocha",_w="#1e1e2e",yw="#181825",Ew="#11111b",Tw="#cdd6f4",Iw="#bac2de",ww="#7f84ac",vw="#585b80",Aw="#313244",Rw="#b4befe",bw="#89b4fa",Po={name:mw,id:gw,background:_w,backgroundDim:yw,backgroundDark:Ew,textBright:Tw,text:Iw,textDull:ww,textDim:vw,textDark:Aw,accent:Rw,accent2:bw},Pw="Catppuccin Latte",Sw="catppuccin-latte",Cw="#eff1f5",kw="#e6e9ef",Dw="#dce0e8",Nw="#2C2F49",Vw="#4c4f69",Ow="#6c6f85",Lw="#8c8fa1",Mw="#ccd0da",xw="#7287fd",Uw="#1e66f5",Fw={name:Pw,id:Sw,background:Cw,backgroundDim:kw,backgroundDark:Dw,textBright:Nw,text:Vw,textDull:Ow,textDim:Lw,textDark:Mw,accent:xw,accent2:Uw},Bw="Midnight",$w="midnight",qw="#111133",jw="#05050F",zw="#000000",Hw="#ccccee",Gw="#bac2de",Ww="#7f849c",Kw="#585b70",Qw="#111122",Jw="#b4befe",Xw="#89b4fa",Yw={name:Bw,id:$w,background:qw,backgroundDim:jw,backgroundDark:zw,textBright:Hw,text:Gw,textDull:Ww,textDim:Kw,textDark:Qw,accent:Jw,accent2:Xw},Zw="Void",ev="void",tv="#000000",nv="#030303",rv="#090909",sv="#FFFFFF",iv="#CCCCCC",ov="#AAAAAA",av="#555555",uv="#222222",cv="#FFFFFF",lv="#FFFFFF",hv={name:Zw,id:ev,background:tv,backgroundDim:nv,backgroundDark:rv,textBright:sv,text:iv,textDull:ov,textDim:av,textDark:uv,accent:cv,accent2:lv},dv="Cotton Candy",fv="cotton-candy",pv="#FFCCEE",mv="#CCDDFF",gv="#FFFFFF",_v="#000000",yv="#000000CC",Ev="#00000099",Tv="#00000055",Iv="#00000028",wv="#222233",vv="#111122",Av={name:dv,id:fv,background:pv,backgroundDim:mv,backgroundDark:gv,textBright:_v,text:yv,textDull:Ev,textDim:Tv,textDark:Iv,accent:wv,accent2:vv},Rv=[Fw,Po,Av,Yw,hv];let Jd=nl(So((()=>{let n=localStorage.getItem("theme");return n?Rv.find(e=>e.id===n)??Po:Po})()));function el(){return Bs(Jd)}function yA(n){tl(Jd,So(n)),localStorage.setItem("theme",n.id)}let bv=$f(()=>`linear-gradient(to bottom right, ${el().accent}, ${el().accent2})`);function EA(){return Bs(bv)}export{Yv as A,tA as B,xv as C,zv as D,gA as E,oA as F,Bv as G,jv as H,Qv as I,Kv as J,aA as K,sA as L,iA as M,dA as N,hA as O,_A as P,fA as Q,uA as R,lA as S,cA as T,Zv as U,EA as a,qv as b,Dv as c,Fv as d,Gv as e,cw as f,aw as g,Uv as h,mA as i,pA as j,Rv as k,Xv as l,yA as m,Wv as n,Jv as o,Hv as p,kn as q,nA as r,Nv as s,el as t,he as u,Er as v,Mv as w,$v as x,eA as y,rA as z};
