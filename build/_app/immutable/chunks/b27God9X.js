 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lf="FirebaseError";class it extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=lf,Object.setPrototypeOf(this,it.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,ur.prototype.create)}}class ur{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,o=this.errors[e],a=o?hf(o,r):"Error",c=`${this.serviceName}: ${a} (${s}).`;return new it(s,c,r)}}function hf(n,e){return n.replace(df,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const df=/\{\$([^}]+)}/g;function ff(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function os(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const o=n[s],a=e[s];if(Ya(o)&&Ya(a)){if(!os(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function Ya(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mp="firebase-heartbeat-database",gp=1,Yn="firebase-heartbeat-store";let wi=null;function Sc(){return wi||(wi=Nf(mp,gp,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Yn)}catch(t){console.warn(t)}}}}).catch(n=>{throw yt.create("idb-open",{originalErrorMessage:n.message})})),wi}async function _p(n){try{const t=(await Sc()).transaction(Yn),r=await t.objectStore(Yn).get(Cc(n));return await t.done,r}catch(e){if(e instanceof it)tt.warn(e.message);else{const t=yt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});tt.warn(t.message)}}}async function ru(n,e){try{const r=(await Sc()).transaction(Yn,"readwrite");await r.objectStore(Yn).put(e,Cc(n)),await r.done}catch(t){if(t instanceof it)tt.warn(t.message);else{const r=yt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});tt.warn(r.message)}}}function Cc(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mc{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class Ap{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(Ie.UNAUTHENTICATED))}shutdown(){}}class Rp{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class bp{constructor(e){this.t=e,this.currentUser=Ie.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){K(this.o===void 0);let r=this.i;const s=l=>this.i!==r?(r=this.i,t(l)):Promise.resolve();let o=new Ze;this.o=()=>{this.i++,this.currentUser=this.u(),o.resolve(),o=new Ze,e.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const l=o;e.enqueueRetryable(async()=>{await l.promise,await s(this.currentUser)})},c=l=>{O("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(l=>c(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?c(l):(O("FirebaseAuthCredentialsProvider","Auth not yet detected"),o.resolve(),o=new Ze)}},0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(O("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(K(typeof r.accessToken=="string"),new Mc(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return K(e===null||typeof e=="string"),new Ie(e)}}class Pp{constructor(e,t,r){this.l=e,this.h=t,this.P=r,this.type="FirstParty",this.user=Ie.FIRST_PARTY,this.T=new Map}I(){return this.P?this.P():null}get headers(){this.T.set("X-Goog-AuthUser",this.l);const e=this.I();return e&&this.T.set("Authorization",e),this.h&&this.T.set("X-Goog-Iam-Authorization-Token",this.h),this.T}}class Sp{constructor(e,t,r){this.l=e,this.h=t,this.P=r}getToken(){return Promise.resolve(new Pp(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(Ie.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Cp{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class kp{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){K(this.o===void 0);const r=o=>{o.error!=null&&O("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${o.error.message}`);const a=o.token!==this.R;return this.R=o.token,O("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(o.token):Promise.resolve()};this.o=o=>{e.enqueueRetryable(()=>r(o))};const s=o=>{O("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=o,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(o=>s(o)),setTimeout(()=>{if(!this.appCheck){const o=this.A.getImmediate({optional:!0});o?s(o):O("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(K(typeof t.token=="string"),this.R=t.token,new Cp(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function uo(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function Ps(n){const e=n.mapValue.fields.__previous_value__;return uo(e)?Ps(e):e}function Xn(n){const e=vt(n.mapValue.fields.__local_write_time__.timestampValue);return new ae(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class De{constructor(e){this.value=e}static empty(){return new De({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!Yr(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Wn(t)}setAll(e){let t=fe.emptyPath(),r={},s=[];e.forEach((a,c)=>{if(!t.isImmediateParentOf(c)){const l=this.getFieldsMap(t);this.applyChanges(l,r,s),r={},s=[],t=c.popLast()}a?r[c.lastSegment()]=Wn(a):s.push(c.lastSegment())});const o=this.getFieldsMap(t);this.applyChanges(o,r,s)}delete(e){const t=this.field(e.popLast());Yr(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return We(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];Yr(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){Pt(t,(s,o)=>e[s]=o);for(const s of r)delete e[s]}clone(){return new De(Wn(this.value))}}function Bc(n){const e=[];return Pt(n.fields,(t,r)=>{const s=new fe([t]);if(Yr(r)){const o=Bc(r.mapValue).fields;if(o.length===0)e.push(s);else for(const a of o)e.push(s.child(a))}else e.push(s)}),new Ne(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tr{constructor(e,t="asc"){this.field=e,this.dir=t}}function Wp(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vs{constructor(e,t,r,s,o){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,hr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new Vs(B.min(),s,new ee(G),rt(),z())}}class hr{constructor(e,t,r,s,o){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new hr(r,t,z(),z(),z())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ym{constructor(){this.changes=new $t(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,we.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?P.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ng{constructor(){this.sessionToken=pe.EMPTY_BYTE_STRING}getSessionToken(e){return P.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,P.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Te="WebChannelConnection";class wg extends class{get Co(){return!1}constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Fo=r+"://"+t.host,this.Mo=`projects/${s}/databases/${o}`,this.xo=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${o}`}Oo(t,r,s,o,a){const c=Ai(),l=this.No(t,r.toUriEncodedString());O("RestConnection",`Sending RPC '${t}' ${c}:`,l,s);const d={"google-cloud-resource-prefix":this.Mo,"x-goog-request-params":this.xo};return this.Bo(d,o,a),this.Lo(t,l,d,s).then(p=>(O("RestConnection",`Received RPC '${t}' ${c}: `,p),p),p=>{throw un("RestConnection",`RPC '${t}' ${c} failed with error: `,p,"url: ",l,"request:",s),p})}ko(t,r,s,o,a,c){return this.Oo(t,r,s,o,a)}Bo(t,r,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+gn}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((o,a)=>t[a]=o),s&&s.headers.forEach((o,a)=>t[a]=o)}No(t,r){const s=Tg[t];return`${this.Fo}/v1/${r}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Lo(e,t,r,s){const o=Ai();return new Promise((a,c)=>{const l=new Dc;l.setWithCredentials(!0),l.listenOnce(Vc.COMPLETE,()=>{try{switch(l.getLastErrorCode()){case Qr.NO_ERROR:const p=l.getResponseJson();O(Te,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),a(p);break;case Qr.TIMEOUT:O(Te,`RPC '${e}' ${o} timed out`),c(new N(b.DEADLINE_EXCEEDED,"Request time out"));break;case Qr.HTTP_ERROR:const E=l.getStatus();if(O(Te,`RPC '${e}' ${o} failed with status:`,E,"response text:",l.getResponseText()),E>0){let A=l.getResponseJson();Array.isArray(A)&&(A=A[0]);const S=A==null?void 0:A.error;if(S&&S.status&&S.message){const k=function(D){const M=D.toLowerCase().replace(/_/g,"-");return Object.values(b).indexOf(M)>=0?M:b.UNKNOWN}(S.status);c(new N(k,S.message))}else c(new N(b.UNKNOWN,"Server responded with status "+l.getStatus()))}else c(new N(b.UNAVAILABLE,"Connection failed."));break;default:U()}}finally{O(Te,`RPC '${e}' ${o} completed.`)}});const d=JSON.stringify(s);O(Te,`RPC '${e}' ${o} sending request:`,s),l.send(t,"POST",d,r,15)})}qo(e,t,r){const s=Ai(),o=[this.Fo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=Lc(),c=Oc(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(l.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Bo(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;const p=o.join("");O(Te,`Creating RPC '${e}' stream ${s}: ${p}`,l);const E=a.createWebChannel(p,l);let A=!1,S=!1;const k=new Ig({Eo:D=>{S?O(Te,`Not sending because RPC '${e}' stream ${s} is closed:`,D):(A||(O(Te,`Opening RPC '${e}' stream ${s} transport.`),E.open(),A=!0),O(Te,`RPC '${e}' stream ${s} sending:`,D),E.send(D))},Ao:()=>E.close()}),V=(D,M,x)=>{D.listen(M,q=>{try{x(q)}catch(Q){setTimeout(()=>{throw Q},0)}})};return V(E,qn.EventType.OPEN,()=>{S||(O(Te,`RPC '${e}' stream ${s} transport opened.`),k.So())}),V(E,qn.EventType.CLOSE,()=>{S||(S=!0,O(Te,`RPC '${e}' stream ${s} transport closed`),k.Do())}),V(E,qn.EventType.ERROR,D=>{S||(S=!0,un(Te,`RPC '${e}' stream ${s} transport errored:`,D),k.Do(new N(b.UNAVAILABLE,"The operation could not be completed")))}),V(E,qn.EventType.MESSAGE,D=>{var M;if(!S){const x=D.data[0];K(!!x);const q=x,Q=(q==null?void 0:q.error)||((M=q[0])===null||M===void 0?void 0:M.error);if(Q){O(Te,`RPC '${e}' stream ${s} received error:`,Q);const te=Q.status;let Z=function(_){const y=se[_];if(y!==void 0)return ol(y)}(te),T=Q.message;Z===void 0&&(Z=b.INTERNAL,T="Unknown error status: "+te+" with message "+Q.message),S=!0,k.Do(new N(Z,T)),E.close()}else O(Te,`RPC '${e}' stream ${s} received:`,x),k.vo(x)}}),V(c,Nc.STAT_EVENT,D=>{D.stat===Li.PROXY?O(Te,`RPC '${e}' stream ${s} detected buffering proxy`):D.stat===Li.NOPROXY&&O(Te,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{k.bo()},0),k}}function Ri(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pn{constructor(e){this._byteString=e}static fromBase64String(e){try{return new pn(pe.fromBase64String(e))}catch(t){throw new N(b.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new pn(pe.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fs{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new N(b.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new fe(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gn{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class eh extends Ql{constructor(e,t,r,s,o,a){super(e,t,r,s,a),this._firestore=e,this._firestoreImpl=e,this.metadata=o}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new es(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const r=this._document.data.field($s("DocumentSnapshot.get",e));if(r!==null)return this._userDataWriter.convertValue(r,t.serverTimestamps)}}}class es extends eh{data(e={}){return super.data(e)}}class S_{constructor(e,t,r,s){this._firestore=e,this._userDataWriter=t,this._snapshot=s,this.metadata=new Gn(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,t){this._snapshot.docs.forEach(r=>{e.call(t,new es(this._firestore,this._userDataWriter,r.key,r,new Gn(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new N(b.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(s,o){if(s._snapshot.oldDocs.isEmpty()){let a=0;return s._snapshot.docChanges.map(c=>{const l=new es(s._firestore,s._userDataWriter,c.doc.key,c.doc,new Gn(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);return c.doc,{type:"added",doc:l,oldIndex:-1,newIndex:a++}})}{let a=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(c=>o||c.type!==3).map(c=>{const l=new es(s._firestore,s._userDataWriter,c.doc.key,c.doc,new Gn(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);let d=-1,p=-1;return c.type!==0&&(d=a.indexOf(c.doc.key),a=a.delete(c.doc.key)),c.type!==1&&(a=a.add(c.doc),p=a.indexOf(c.doc.key)),{type:C_(c.type),doc:l,oldIndex:d,newIndex:p}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function C_(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return U()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _r{constructor(e,t){this.shortDelay=e,this.longDelay=t,st(t>e,"Short delay should be less than long delay!"),this.isMobile=ef()||sf()}get(){return x_()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sr(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof it&&H_(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function H_({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Y_(n,e){const t=await oh(n,{},async()=>{const r=cr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:o}=n.config,a=ah(n,s,"/v1/token",`key=${o}`),c=await n._getAdditionalHeaders();return c["Content-Type"]="application/x-www-form-urlencoded",ih.fetch()(a,{method:"POST",headers:c,body:r})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function X_(n,e){return kt(n,"POST","/v2/accounts:revokeToken",Ct(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zu(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(ph(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(hh(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(gh(e))return"Blackberry";if(_h(e))return"Webos";if(dh(e))return"Safari";if((e.includes("chrome/")||fh(e))&&!e.includes("edge/"))return"Chrome";if(mh(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function hh(n=ve()){return/firefox\//i.test(n)}function dh(n=ve()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function fh(n=ve()){return/crios\//i.test(n)}function ph(n=ve()){return/iemobile/i.test(n)}function mh(n=ve()){return/android/i.test(n)}function gh(n=ve()){return/blackberry/i.test(n)}function _h(n=ve()){return/webos/i.test(n)}function zo(n=ve()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Z_(n=ve()){var e;return zo(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function ey(){return of()&&document.documentMode===10}function yh(n=ve()){return zo(n)||mh(n)||_h(n)||gh(n)||/windows phone/i.test(n)||ph(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Eh(n,e=[]){let t;switch(n){case"Browser":t=Zu(ve());break;case"Worker":t=`${Zu(ve())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${mn}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ty(n,e){return yr(n,"POST","/v1/accounts:signInWithPassword",Ct(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Iy(n,e){return yr(n,"POST","/v1/accounts:signInWithEmailLink",Ct(n,e))}async function wy(n,e){return yr(n,"POST","/v1/accounts:signInWithEmailLink",Ct(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function on(n,e){return yr(n,"POST","/v1/accounts:signInWithIdp",Ct(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ay(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Ry(n){const e=Bn($n(n)).link,t=e?Bn($n(e)).deep_link_id:null,r=Bn($n(n)).deep_link_id;return(r?Bn($n(r)).link:null)||r||t||e||n}class Wo{constructor(e){var t,r,s,o,a,c;const l=Bn($n(e)),d=(t=l.apiKey)!==null&&t!==void 0?t:null,p=(r=l.oobCode)!==null&&r!==void 0?r:null,E=Ay((s=l.mode)!==null&&s!==void 0?s:null);F(d&&p&&E,"argument-error"),this.apiKey=d,this.operation=E,this.code=p,this.continueUrl=(o=l.continueUrl)!==null&&o!==void 0?o:null,this.languageCode=(a=l.languageCode)!==null&&a!==void 0?a:null,this.tenantId=(c=l.tenantId)!==null&&c!==void 0?c:null}static parseLink(e){const t=Ry(e);try{return new Wo(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class In{constructor(){this.providerId=In.PROVIDER_ID}static credential(e,t){return ir._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=Wo.parseLink(t);return F(r,"argument-error"),ir._fromEmailAndCode(e,r.code,r.tenantId)}}In.PROVIDER_ID="password";In.EMAIL_PASSWORD_SIGN_IN_METHOD="password";In.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Er extends vh{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function by(n,e){return yr(n,"POST","/v1/accounts:signUp",Ct(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TE=new _r(5e3,15e3),IE="__/auth/iframe",wE="emulator/auth/iframe",vE={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},AE=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function RE(n){const e=n.config;F(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?qo(e,wE):`https://${n.config.authDomain}/${IE}`,r={apiKey:e.apiKey,appName:n.name,v:mn},s=AE.get(n.config.apiHost);s&&(r.eid=s);const o=n._getFrameworks();return o.length&&(r.fw=o.join(",")),`${t}?${cr(r).slice(1)}`}async function bE(n){const e=await EE(n),t=Ge().gapi;return F(t,n,"internal-error"),e.open({where:document.body,url:RE(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:vE,dontclear:!0},r=>new Promise(async(s,o)=>{await r.restyle({setHideOnLeave:!1});const a=ze(n,"network-request-failed"),c=Ge().setTimeout(()=>{o(a)},TE.get());function l(){Ge().clearTimeout(c),s(r)}r.ping(l).then(l,()=>{o(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Et(KE,QE,"app");const JE={apiKey:"AIzaSyAiesvbsJsfqv1Iz13HoHZCkg4aCDAnQ-0",authDomain:"bookfly-5efc3.firebaseapp.com",projectId:"bookfly-5efc3",storageBucket:"bookfly-5efc3.firebasestorage.app",messagingSenderId:"418964211654",appId:"1:418964211654:web:5345a85c119696741dd4c7",measurementId:"G-T5BQ99KSZS"},YE={firebase:JE};let Kr,fc;function Hs(){return Kr||(Kr=bc(YE.firebase),fc=p_(Kr)),{app:Kr,db:fc}}let{db:XE}=Hs();async function kI(n){let e=(await Re(Ae(oe(XE,"posts"),me("books","array-contains",n),Yl("timestamp","desc")))).docs.map(t=>t.data());return await Promise.all(e.map(t=>Wt(t)))}async function or(n){var c;const e=localStorage.getItem(`book-${n}`);if(e)return JSON.parse(e);let[t,r]=await Promise.all([fetch(`https://openlibrary.org/isbn/${n}.json`),fetch(`https://openlibrary.org/search.json?isbn=${n}`)]),[s,o]=await Promise.all([t.json(),await r.json()]);const a={title:s.title,authors:Array.from(new Set(o.docs[0].author_name)),isbn:n,cover:`https://covers.openlibrary.org/b/isbn/${n}-L.jpg`,pageCount:s.number_of_pages,genres:((c=s.subjects)==null?void 0:c.map(l=>l.name))??[],description:s.description??""};return localStorage.setItem(`book-${n}`,JSON.stringify(a)),a}async function DI(n,e=10){/^\d{13}$/.test(n)&&or(n).then(a=>[a]);const t=new URLSearchParams({q:n}),s=await(await fetch(`https://openlibrary.org/search.json?${t}&fields=isbn,editions`)).json();console.log(s);let o=s.docs.filter(a=>a.isbn).slice(0,e);return await Promise.all(o.map(a=>or(a.isbn.find(c=>/^\d{13}$/.test(c)))))}let{db:Ir}=Hs();function VI(n){let e=[];return n.length<1&&e.push("Username can't be empty"),n.length>30&&e.push("Username can't be more than 30 characters"),/^[\w\-]*$/.test(n)||e.push("Username can only contain letters, numbers, underscores, and hyphens"),e}let Fh,NI=new Promise(n=>{Fh=n});async function OI(n){let t=(await Re(Ae(oe(Ir,"posts"),me("poster","==",n.id),me("type","==","rating")))).docs.map(r=>r.data()).toSorted((r,s)=>s.rating-r.rating).map(r=>r.books[0]);return t.length>0?await or(t[0]):null}async function ZE(n){return(await Re(Ae(oe(Ir,"users"),me("id","==",n)))).docs[0].data()}async function eT(n){return n}async function LI(n){return(await Re(Ae(oe(Ir,"users"),me("username","==",n)))).docs[0].data()}async function MI(n){let e=(await Re(Ae(oe(Ir,"posts"),me("poster","==",n.id),Yl("timestamp","desc")))).docs.map(r=>r.data());return await Promise.all(e.map(async r=>Wt(r)))}async function xI(n){return(await Re(Ae(oe(Ir,"users")))).docs.map(t=>t.data()).filter(t=>t.username.toLowerCase().includes(n.toLowerCase())||t.displayName.includes(n.toLowerCase()))}let{db:wn}=Hs();const wr=WE();Vy(wr,Ch);let ws=mc(null);function Ce(){return ar(ws)}function FI(n){let e=[];return/\d/.test(n)||e.push("Must contain at least 1 number"),/[a-z]/.test(n)||e.push("Must contain at least 1 lowercase letter"),/[A-Z]/.test(n)||e.push("Must contain at least 1 uppercase letter"),/[\$_=\+\*!@#%\^&\|\\\/\(\)\[\]\{\}<>\?:;'"`~\-]/.test(n)||e.push("Must contain at least 1 symbol"),n.length<8&&e.push("Must be at least 8 characters"),e}async function UI(n){return(await Re(Ae(oe(wn,"users"),me("username","==",n)))).docs.length>0}async function BI(n){return(await Re(Ae(oe(wn,"users"),me("email","==",n)))).docs.length>0}Ly(wr,async n=>{n&&(pc(ws,ro(await eT((await Re(Ae(oe(wn,"users"),me("id","==",n.uid)))).docs[0].data()))),Fh(ar(ws)))});async function $I(){try{return await My(wr),null}catch(n){return console.log(n),n}}async function tT(n){let e={...ar(ws),...n};await Uo(ot(wn,"users",e.id),e)}async function qI(n,e){let t={...n,...e};await Uo(ot(wn,"users",t.id),t)}async function jI(n,e,t){try{let r=await ky(wr,n,e),s={displayName:t,email:n,username:t,picture:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToiRnzzyrDtkmRzlAvPPbh77E-Mvsk3brlxQ&s",bio:"",pronouns:"",likes:[],id:r.user.uid,banner:"https://i0.wp.com/www.lifecaretechnology.com/wp-content/uploads/2018/12/default-banner.jpg?ssl=1",tags:[],links:[],currentBook:null,readingList:[],following:[],followers:[],views:[],shares:[]};return await Uo(ot(wn,"users",s.id),s),null}catch(r){return console.log(r),r}}async function zI(n,e){try{return await Dy(wr,n,e),null}catch(t){return console.log(t),t}}let{db:Oe}=Hs();async function GI(n){let e={timestamp:Date.now(),poster:Ce().id,authors:[],books:[],views:[],likes:[],shares:[],pictures:[],id:"",...n};console.log(e);let t=await V_(oe(Oe,"posts"),e);return qs(t,{id:t.id}),Wt({...e,id:t.id})}async function WI(n){await D_(ot(Oe,"posts",n.id))}async function Wt(n){let e={...n,poster:await ZE(n.poster),books:await Promise.all(n.books.map(async t=>or(t)))};return Ce()&&!Ce().views.includes(e.id)&&tT({views:[...Ce().views,e.id]}),e}async function HI(n){try{return Wt((await k_(ot(Oe,"posts",n))).data())}catch{return null}}async function KI(n){let e=(await Re(Ae(oe(Oe,"posts")))).docs.map(r=>r.data());return(await Promise.all(e.map(async r=>Wt(r)))).filter(r=>r.body.toLowerCase().includes(n.toLowerCase()))}async function QI(n,e){if(n.following.length===0)return[];let t=me("poster","in",n.following);t=R_(t,me("poster","==",n.id));let r=(await Re(Ae(oe(Oe,"posts"),t))).docs.map(o=>o.data());return await Promise.all(r.map(async o=>Wt(o)))}async function JI(n){return Promise.all((await Re(Ae(oe(Oe,"posts"),me("parent","==",n.id)))).docs.map(e=>Wt(e.data())))}async function YI(n){return(await Re(Ae(oe(Oe,"users"),me("likes","array-contains",n.id)))).docs.map(e=>e.data())}async function XI(n){return(await Re(Ae(oe(Oe,"users"),me("shares","array-contains",n.id)))).docs.map(e=>e.data())}let nT=/(https?:\/\/)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/g;async function rT(n,e,t){const r=[];n.replaceAll(e,(o,...a)=>(r.push(t(o,...a)),o));const s=await Promise.all(r);return n.replaceAll(e,()=>s.shift())}async function ZI(n){return n=n.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#x27;"),n=await rT(n,/@(\d{13})/g,async(e,t)=>{const r=await or(t);return`<a style="text-decoration: none;" href="/book/${t}"><i>${r.title}</i></a>`}),n.replaceAll(/@(\w+)/g,(e,t)=>`<a style="text-decoration: none;" href="/profile/${t}">${e}</a>`).replaceAll(/\*\*([^\*]+)\*\*/g,(e,t)=>`<b>${t}</b>`).replaceAll(/\*([^\*]+)\*/g,(e,t)=>`<i>${t}</i>`).replaceAll(/`([^\`]+)`/g,(e,t)=>`<code>${t}</code>`).replaceAll(/~~([^~]+)~~/g,(e,t)=>`<s>${t}</s>`).replaceAll(nT,e=>`<a target="_blank" rel="noopener noreferrer" href="${e}">${e}</a>`).replaceAll(/\\\*/g,"*").replaceAll(/\\`/g,"`").replaceAll("`","&#x60;")}async function ew(n){let e=(await Re(Ae(oe(Oe,"users"),me("views","array-contains",n.id)))).docs,t=e.length;return(!Ce()||!e.map(r=>r.id).includes(Ce().id))&&(t+=1),t}async function tw(n){await qs(ot(oe(Oe,"users"),Ce().id),{likes:[...new Set([...Ce().likes,n.id])]})}async function nw(n){await qs(ot(oe(Oe,"users"),Ce().id),{shares:[...new Set([...Ce().shares,n.id])]})}async function rw(n){await qs(ot(oe(Oe,"users"),Ce().id),{likes:Ce().likes.filter(e=>e!==n.id)})}async function sw(n){return Ce().likes.includes(n.id)}async function iw(n){return Ce().shares.includes(n.id)}async function ow(n){return(await Re(Ae(oe(Oe,"posts"),me("parent","==",n.id),me("poster","==",Ce().id)))).docs.length>0}const sT="Catppuccin Mocha",iT="catppuccin-mocha",oT="#1e1e2e",aT="#181825",uT="#11111b",cT="#cdd6f4",lT="#bac2de",hT="#7f84ac",dT="#585b80",fT="#313244",pT="#b4befe",mT="#89b4fa",to={name:sT,id:iT,background:oT,backgroundDim:aT,backgroundDark:uT,textBright:cT,text:lT,textDull:hT,textDim:dT,textDark:fT,accent:pT,accent2:mT},gT="Catppuccin Latte",_T="catppuccin-latte",yT="#eff1f5",ET="#e6e9ef",TT="#dce0e8",IT="#2C2F49",wT="#4c4f69",vT="#6c6f85",AT="#8c8fa1",RT="#ccd0da",bT="#7287fd",PT="#1e66f5",ST={name:gT,id:_T,background:yT,backgroundDim:ET,backgroundDark:TT,textBright:IT,text:wT,textDull:vT,textDim:AT,textDark:RT,accent:bT,accent2:PT},CT="Midnight",kT="midnight",DT="#111133",VT="#05050F",NT="#000000",OT="#ccccee",LT="#bac2de",MT="#7f849c",xT="#585b70",FT="#111122",UT="#b4befe",BT="#89b4fa",$T={name:CT,id:kT,background:DT,backgroundDim:VT,backgroundDark:NT,textBright:OT,text:LT,textDull:MT,textDim:xT,textDark:FT,accent:UT,accent2:BT},qT="Void",jT="void",zT="#000000",GT="#030303",WT="#090909",HT="#FFFFFF",KT="#CCCCCC",QT="#AAAAAA",JT="#555555",YT="#222222",XT="#FFFFFF",ZT="#FFFFFF",eI={name:qT,id:jT,background:zT,backgroundDim:GT,backgroundDark:WT,textBright:HT,text:KT,textDull:QT,textDim:JT,textDark:YT,accent:XT,accent2:ZT},tI="Cotton Candy",nI="cotton-candy",rI="#FFCCEE",sI="#CCDDFF",iI="#FFFFFF",oI="#000000",aI="#000000CC",uI="#00000099",cI="#00000055",lI="#00000028",hI="#222233",dI="#111122",fI={name:tI,id:nI,background:rI,backgroundDim:sI,backgroundDark:iI,textBright:oI,text:aI,textDull:uI,textDim:cI,textDark:lI,accent:hI,accent2:dI},pI=[ST,to,fI,$T,eI];let Uh=mc(ro((()=>{let n=localStorage.getItem("theme");return n?pI.find(e=>e.id===n)??to:to})()));function vs(){return ar(Uh)}function aw(n){pc(Uh,ro(n)),localStorage.setItem("theme",n.id)}let mI=Rd(()=>`linear-gradient(to bottom right, ${vs().accent}, ${vs().accent2})`);function uw(){return ar(mI)}var gI=Fd('<div class="svelte-1q9qxfr"></div>');function cw(n,e){bd(e,!1),Ud();var t=gI();Pd(r=>jd(t,"background-image",r),[()=>`linear-gradient(${vs().background}, ${vs().backgroundDim})`],Cd),xd(n,t),Sd()}export{Hs as A,cw as B,QI as C,HI as D,JI as E,OI as F,MI as G,ZI as H,qI as I,$I as J,ew as K,YI as L,XI as M,sw as N,iw as O,ow as P,tw as Q,rw as R,nw as S,WI as T,bI as a,jd as b,NI as c,RI as d,UI as e,tT as f,VI as g,pI as h,aw as i,uw as j,BI as k,zI as l,jI as m,or as n,kI as o,FI as p,GI as q,AI as r,Ci as s,vs as t,Ce as u,DI as v,LI as w,ZE as x,KI as y,xI as z};
