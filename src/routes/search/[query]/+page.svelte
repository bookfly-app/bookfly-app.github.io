		...
		<div class="views">
			...
			<button
				style:color={view === "people"
					? theme().textBright
					: theme().textDull}
				style:border-color={view === "people"
					? theme().accent
					: "transparent"}
				onclick={() => (view = "people")}
			>
		...
		{#await posts}
			<div class="loading">
				...
				<p style:color={theme().textDull}>
					We promise Bookfly will be faster soon.
				</p>
			</div>
		{:then posts}
			{#if posts.length === 0}
				<div class="loading">
					...
					<p style:color={theme().textDull}>
						No posts were found relating to your search term. Make
						sure you spelled everything right!
					</p>
				</div>
			{/if}
			{#each posts as post}
		...
		{:then books}
			{#if books.length === 0}
				<div class="loading">
					...
					<p style:color={theme().textDull}>
						No books were found relating to your search term. Make
						sure you spelled everything right!
					</p>
				</div>
			{/if}
		...
		{:then users}
			{#if users.length === 0}
				<div class="loading">
					...
					<p style:color={theme().textDull}>
						No users were found relating to your search term. Make
						sure you spelled everything right!
					</p>
				</div>
			{/if}
