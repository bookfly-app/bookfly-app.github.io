...
<Page class="about">
	...
	<!-- Technical Details -->
	<h2>Moderating Details</h2>
	<p>
		Moderators for wallflower.land can delete other users posts, ban
		their accounts, unban their accounts, etc. It's a lot of responsibility.
	</p>

	<p>
		Because of that, I'm currently only accepting moderator requests from people
		...
		you personally&mdash;are slim. 
	</p>

	<p>
		That being said, it's not impossible. Reach out to me and we can chat. It helps
		if you have a long-standing active account on wallflower.land.
	</p>
</Page>
